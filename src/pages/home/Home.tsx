          ...
          <div className="flex flex-col items-center text-center gap-10">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight">
                경매의 새로운 <span className="text-purple-600">차원</span>
              </h1>
            ...
            <div className="w-full max-w-2xl">
              <div className="relative">
                ...
                />
                <button className="absolute right-2 top-1/2 -translate-y-1/2 px-6 py-2 rounded-full bg-purple-600 text-white text-sm font-semibold hover:bg-purple-700 transition-colors">
                  검색
                </button>
              </div>
            </div>
          ...
          <div className="bg-slate-900 rounded-3xl px-8 py-10 md:px-12 md:py-12 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="px-8 py-3 rounded-full bg-white text-slate-900 text-sm font-semibold hover:bg-slate-100 cursor-pointer"
              >
                무료 회원가입
              ...
              <button
                ...
                className="px-8 py-3 rounded-full border border-slate-500 text-sm font-semibold text-slate-100 hover:bg-slate-800 cursor-pointer"
              >
                경매 둘러보기
              </button>
            </div>
