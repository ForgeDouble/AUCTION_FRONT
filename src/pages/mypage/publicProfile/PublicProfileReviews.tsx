          ...
          {r.tags?.length ? (
            <div className="mt-3 flex flex-wrap gap-2.5">
              {r.tags.slice(0, 8).map((t) => (
                <span
                  key={String(t)}
                  className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-[rgba(118,90,255,0.08)] border border-[rgba(118,90,255,0.25)] text-xs font-semibold text-gray-800 shadow-sm hover:bg-[rgba(118,90,255,0.12)] hover:border-[rgba(118,90,255,0.35)] hover:shadow-md transition-all cursor-default select-none"
                >
              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-5">
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-2xl bg-[rgb(118,90,255)] text-white text-sm font-extrabold hover:brightness-95 active:scale-[0.98] transition-all"
                  >
                    상품으로 이동
                  </button>
                ...
                {data.tags && data.tags.length > 0 && (
                  <div className="flex flex-wrap gap-2.5 mb-5">
                    {data.tags.slice(0, 10).map((t: any) => (
                      <span
                        key={t}
                        className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-[rgba(118,90,255,0.10)] border border-[rgba(118,90,255,0.30)] text-xs font-semibold text-gray-900"
                      >
                        <Tag className="w-3 h-3 text-[rgb(118,90,255)]" />
                        {isReviewTag(t) ? REVIEW_TAG_LABEL[t] : String(t)}
                      </span>
